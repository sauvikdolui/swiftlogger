...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //         Usage
                ...
                Logger.printDebugInfo(debugMessage: "This is a WARNING message", event: .warning) // WARNING log
                Logger.printDebugInfo(debugMessage: "This is a SEVERE message", event: .severe) // SEVERE Error log
